...
class TestTimeSeries(unittest.TestCase):
    ...
    def test_rolling_cagr_long_window_error(self):
        ...
        series = pd.Series(np.arange(1000), index=pd.date_range(start='2010-01-01', periods=1000, freq='B'))
    ...
    def test_rolling_cagr_known_df(self):
        ...
        self.assertEqual( valid_cagrs.iloc[:,0].nunique(), 2, "Expected 2 unique values in the CAGR DataFrame, 261 & 262 bdays")
